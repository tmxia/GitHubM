        ...
        <div className="pl-8 pr-4 pb-2 space-y-0.5">
          ...
          <div className="pt-2 pb-1">
            <Button
              variant="ghost"
              size="sm"
              className={`h-7 text-xs gap-1.5 border transition-colors ${showLogs ? 'border-primary/40 text-primary bg-primary/10' : 'border-border text-foreground bg-secondary hover:bg-secondary/80'}`}
